    ...
    <!-- Pilihan Section -->
        <section class="max-w-screen">
            <div class="flex pt-16 px-10 md:pt-20 md:px-16 lg:px-32 gap-6 md:gap-8">
                <a href="akademi.php">
                    <button class="bg-stack-orange px-8 py-3 md:px-12 md:py-3 lg:px-16 lg:py-4 rounded-xl text-white font-semibold font-poppins block active:scale-95 hover:bg-orange-hover active:bg-orange-active hover:scale-105 transition duration-300 shadow-[0_0_15px_4px_rgba(255,120,0,0.9)] lg:text-lg md:text-xl whitespace-nowrap">
                        Akademi MLBB
                    </button>
                </a>            
                <a href="coaching.php">
                    <button class="bg-stack-orange px-8 py-3 md:px-12 md:py-3 lg:px-16 lg:py-4 rounded-xl text-white font-semibold font-poppins block active:scale-95 hover:bg-orange-hover active:bg-orange-active shadow-md hover:scale-105 transition duration-300 hover:shadow-[0_0_15px_4px_rgba(255,120,0,0.9)] lg:text-lg md:text-xl whitespace-nowrap">
