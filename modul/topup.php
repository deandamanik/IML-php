...
<body class="bg-black">
    ...
    <section class="max-w-screen">
        <div class="flex pt-16 px-10 md:pt-20 md:px-16 lg:px-32 gap-6 md:gap-8">
            <a href="akademi.php">
                <button class="bg-stack-orange px-8 py-3 md:px-12 md:py-3 lg:px-16 lg:py-4 rounded-xl text-white font-semibold font-poppins block active:scale-95 hover:bg-orange-hover active:bg-orange-active hover:scale-105 transition duration-300 hover:shadow-[0_0_15px_4px_rgba(255,120,0,0.9)] text-lg md:text-xl whitespace-nowrap">
                    Akademi MLBB
                </button>
            </a>            
            <a href="coaching.php">
        ...
        <section class="flex justify-center">
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-20 px-6 md:px-28 lg:px-48 w-full max-w-full">
                <label class="relative cursor-pointer block w-full">
                    <input type="radio" name="id_modul" class="peer hidden" value="8" required>
                ...
                <label class="relative cursor-pointer block w-full">
                    <input type="radio" name="id_modul" class="peer hidden" value="9"> 
                    <div class="w-full peer-checked:shadow-[0_0_20px_5px_rgba(255,120,0,0.9)] peer-checked:scale-105 transition-all duration-300 hover:scale-105 active:scale-95 rounded-xl">
                        <img src="../img/topup/dm2.png" alt="44 Diamond">
                    </div>
                </label>
                <label class="relative cursor-pointer block w-full">
                    <input type="radio" name="id_modul" class="peer hidden" value="10"> 
                    <div class="w-full peer-checked:shadow-[0_0_20px_5px_rgba(255,120,0,0.9)] peer-checked:scale-105 transition-all duration-300 hover:scale-105 active:scale-95 rounded-xl">
                        <img src="../img/topup/dm3.png" alt="170 Diamond">
                    </div>
                </label>
                <label class="relative cursor-pointer block w-full">
                    <input type="radio" name="id_modul" class="peer hidden" value="11"> 
                    <div class="w-full peer-checked:shadow-[0_0_20px_5px_rgba(255,120,0,0.9)] peer-checked:scale-105 transition-all duration-300 hover:scale-105 active:scale-95 rounded-xl">
                        <img src="../img/topup/dm4.png" alt="875 Diamond">
                    </div>
                </label>
                <label class="relative cursor-pointer block w-full">
                    <input type="radio" name="id_modul" class="peer hidden" value="12"> 
                    <div class="w-full peer-checked:shadow-[0_0_20px_5px_rgba(255,120,0,0.9)] peer-checked:scale-105 transition-all duration-300 hover:scale-105 active:scale-95 rounded-xl">
                        <img src="../img/topup/dm5.png" alt="2010 Diamond">
                    </div>
                </label>
                <label class="relative cursor-pointer block w-full">
                    <input type="radio" name="id_modul" class="peer hidden" value="13"> 
                    <div class="w-full peer-checked:shadow-[0_0_20px_5px_rgba(255,120,0,0.9)] peer-checked:scale-105 transition-all duration-300 hover:scale-105 active:scale-95 rounded-xl">
