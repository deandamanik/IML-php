...
<body class="bg-black text-white">
    ...
    <div class="px-6 md:px-12 lg:px-24 mt-8 space-y-4">
        <form method="POST">
            <button type="submit" 
                    class="w-full bg-stack-orange hover:bg-orange-600 text-white font-bold py-3 px-6 rounded-lg 
                           transition-all duration-300 transform hover:scale-[1.02] shadow-lg hover:shadow-orange-500/20">
                KONFIRMASI PEMBAYARAN
            </button>
        </form>
        
        <a href="../pesansekarang/akademi.php" class="block">
            <button class="w-full bg-gray-700 hover:bg-gray-600 text-white font-bold py-3 px-6 rounded-lg 
